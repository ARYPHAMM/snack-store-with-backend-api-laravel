...
$baseUrl = explode("/assets/", $_SERVER['PHP_SELF']);
$baseUrl = $baseUrl[0] . "/upload/";
$baseRes = "upload/";

// var_dump($_SERVER['DOCUMENT_ROOT'].$baseUrl);
// exit();
...
$config['licenseKey']  = 'KP2PK3CXY8RB3ZD6FJR54D5CTCTJK';
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => $baseRes,
    'root'         => $_SERVER['DOCUMENT_ROOT'].$baseUrl, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0777,
